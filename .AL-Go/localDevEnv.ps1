...
$GitHubHelperUrl = 'https://raw.githubusercontent.com/freddydk/AL-Go/lowhanging/Actions/Github-Helper.psm1'
...
$ALGoHelperUrl = 'https://raw.githubusercontent.com/freddydk/AL-Go/lowhanging/Actions/AL-Go-Helper.ps1'
